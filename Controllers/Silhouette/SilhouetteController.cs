...
namespace backend.Controllers
{
    ...
    public class SilhouetteController : ControllerBase
    {
        ...
        /// <summary>
        /// 【前端不用接：直接當圖片網址】依抽中的地區/地點名稱與亮度閾值，從 Neo4j 圖譜抓取圖片並即時轉為剪影圖片輸出。
        /// </summary>
        /// <remarks>
        /// **前端使用方式**：
        ...
        /// <response code="200">回傳 PNG 圖片（不是 JSON）</response>
        [HttpGet]
        [Route("dynamic-image")]
        ...
        /// <summary>
        /// 【前端不用接：直接當圖片網址】取得指定剪影代號的真實圖片檔案。
        /// </summary>
        /// <remarks>
        /// `&lt;img src="https://你的後端網址/api/Silhouette/{silhouette_id}/Image" /&gt;`
        /// </remarks>
        /// <response code="200">回傳圖片檔案（不是 JSON）</response>
        [HttpGet]
